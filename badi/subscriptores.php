...
<div id="page-wrap">
	...
	<!-- <a href="export_files.php?status=1" class="btn btn-success">Exportar Excel</a><br><br> -->
	...
	<table>
		...
		if($query = mysqli_query($connect , "SELECT * FROM clientes_correo ORDER BY fecha_registro DESC")){
			...
			if(mysqli_num_rows($query)){
				...
				while ($data = mysqli_fetch_assoc($query)) {
					...
					echo '<tr>
							...
							<td class="nomover">'.$data["correo"].'</td>
						</tr>';
				}
